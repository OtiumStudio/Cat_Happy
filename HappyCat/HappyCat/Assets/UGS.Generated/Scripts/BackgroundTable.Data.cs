...
namespace BackgroundTable
{
    ...
    { 
        ...
        static string spreadSheetID = "1Fe5s_SVqsBMGKfBNzb3cZ2oph_MbQNrjgTXspvbiSr0"; // it is file id
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("BackgroundTable"); 
            if (text != null)
            {
