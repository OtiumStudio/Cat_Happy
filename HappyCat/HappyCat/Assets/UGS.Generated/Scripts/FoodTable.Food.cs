...
namespace FoodTable
{
    ...
    { 
        ...
        static string spreadSheetID = "1iCqOyWXNOpobbfzVKlWUc6qEKIYW7CaDfwOTtCo8QdU"; // it is file id
...
/* Your Loaded Data Storage. */
        ...
        /// <summary>
        /// Get Food Dictionary, keyType is your sheet A1 field type.
        /// - Auto Load
        /// </summary>
        public static Dictionary<int, Food>  GetDictionary()
        {{
           if (isLoaded == false) Load();
           return FoodMap;
        }}
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("FoodTable"); 
            if (text != null)
            {
    ...
    public static (List<Food> list, Dictionary<int, Food> map) CommonLoad(Dictionary<string, Dictionary<string, List<string>>> jsonObject, bool forceReload){
            Dictionary<int, Food> Map = new Dictionary<int, Food>();
            List<Food> List = new List<Food>();     
            TypeMap.Init();
            FieldInfo[] fields = typeof(Food).GetFields(BindingFlags.Public | BindingFlags.Instance);
            List<(string original, string propertyName, string type)> typeInfos = new List<(string, string, string)>(); 
            List<List<string>> rows = new List<List<string>>();
            var sheet = jsonObject["Food"];
        ...
        public static void Write(Food data, System.Action<WriteObjectResult> onWriteCallback = null)
        { 
            TypeMap.Init();
            FieldInfo[] fields = typeof(Food).GetFields(BindingFlags.Public | BindingFlags.Instance);
