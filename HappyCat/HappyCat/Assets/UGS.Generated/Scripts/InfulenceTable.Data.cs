...
namespace InfulenceTable
{
    ...
    { 
        ...
        static string spreadSheetID = "1GEYuEC02EZ_rR-yWNmmrfRu4xkfg_CkGP5iqxfmgl1o"; // it is file id
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("InfulenceTable"); 
            if (text != null)
            {
