...
namespace WorkerLevelTable
{
    ...
    { 
        ...
        static string spreadSheetID = "1WGPfCg-yJbevsC0Jwxiw2Bq3vHGrJW3KQ6IqDs47G18"; // it is file id
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("WorkerLevelTable"); 
            if (text != null)
            {
